...
const en: Translations = {
  ...
  workoutDurationDesc:
    "Total time for this exercise. Divided equally across sets to calculate calories per set.",
  // Cardio
  ...
  settingBodyFatDesc:
    "Logged alongside each workout entry to track body composition over time.",
  ...
  bodyMetricsEmpty:
    "No data found. Enable calorie calculation and log your body weight.",
