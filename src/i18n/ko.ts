...
const ko: Translations = {
  ...
  bodyFatLabel: "체지방률 (%)",
  bodyFatDesc:
    "현재 체지방률. 기록과 함께 저장되며 플러그인 설정과 동기화됩니다.",
  workoutDurationLabel: "전체 운동 시간 (분)",
  workoutDurationDesc:
    "이 운동에 소요된 총 시간. 세트 수로 나누어 세트별 소모 칼로리를 계산합니다.",
  // Cardio
  ...
  settingCalcCaloriesDesc:
    "METs, 체중, 운동 시간을 기반으로 소모 칼로리를 계산합니다.",
  ...
  settingBodyMetricsNoteDesc:
    "체중과 체지방률을 일별로 기록하는 노트 경로 (칼로리 계산 활성화 시 사용).",
  // Dashboard
  ...
  bodyMetricsEmpty:
    "데이터가 없습니다. 칼로리 계산을 활성화하고 체중을 기록하세요.",
  chartWeight: "체중",
  chartBodyFat: "체지방률",
